...
<link href="${pageContext.request.contextPath }/css/Style.css" type="text/css" rel="stylesheet">
  ...
  <script language="javascript"> 
   function checkchar(){
  		document.Form1.action="${pageContext.request.contextPath }/system/elecTextAction_save.action";
...
<form name="Form1" id="Form1" method=post>
	...
	<table cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#f5fafe" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<input name="textDate1" type="text" maxlength="50" size=20 onclick="WdatePicker()" >
			</td>
