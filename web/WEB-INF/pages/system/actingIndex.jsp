...
<script type="text/javascript" src="${pageContext.request.contextPath }/script/highslide/highslide-html.js"></script>
	<script language="javascript">
		function checkchar(){
			...
			document.Form2.action="elecCommonMsgAction_savePending.action";
				...
				<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
					...
					<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
						<td style="HEIGHT:22px" align="center" width="40%">
							...
							<div>
								<a style="CURSOR:hand" href="${pageContext.request.contextPath }/system/elecCommonMsgAction_actingView.action?"
								   onclick="return hs.htmlExpand(this, { contentId: 'highslide-html-1', objectType: 'ajax', preserveContent: true} )">
						...
						<td style="HEIGHT:22px" align="center" width="40%">
							...
							<div>
								<a style="CURSOR:hand" href="${pageContext.request.contextPath }/system/elecCommonMsgAction_actingView.action?" onclick="return hs.htmlExpand(this, { contentId: 'highslide-html-1', objectType: 'ajax', preserveContent: true} )">
									<div class="scrollStyle" align="left" style="table-layout:fixed;">
										查看设备详细信息
									</div>
								</a>
